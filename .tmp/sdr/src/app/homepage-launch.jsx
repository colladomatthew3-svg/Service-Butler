...
exports.default = LaunchHomepage;
...
function LaunchHomepage() {
    const structuredData = {
        ...
        operatingSystem: "Web",
        description: "Service Butler helps restoration and home service operators find real opportunities before competitors and convert them into booked jobs."
    };
    return (<>
      <TopNav_1.TopNav />
      <main>
            ...
            <div className="grid gap-12 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
              <div className="max-w-2xl">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <link_1.default href="/login" className={(0, button_1.buttonStyles)({ size: "lg" })}>
                    Try Demo
                  </link_1.default>
                  <a href="mailto:sales@servicebutler.ai?subject=Service%20Butler%20Launch%20Demo" className={(0, button_1.buttonStyles)({ size: "lg", variant: "secondary" })}>
                    Book Demo
                  </a>
                </div>
              </div>
                  ...
                  <div className="overflow-hidden rounded-[1.6rem] border border-semantic-border bg-[linear-gradient(180deg,rgba(244,247,245,1),rgba(233,238,235,1))]">
                    <div className="p-4 sm:p-5">
                      <div className="overflow-hidden rounded-[1.4rem] border border-white/70 bg-white">
                        <image_1.default src="/marketing/hero-property-visual.svg" alt="Property preview showing the kind of homes surfaced by Service Butler" width={1200} height={860} className="h-auto w-full object-cover" priority/>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="page-section border-t border-semantic-border/70 bg-white/72 py-12">
          <div className="container">
            ...
            <div className="mt-8 grid gap-4 lg:grid-cols-3">
              {whyItMatters.map(([title, detail]) => (<article key={title} className="rounded-[1.35rem] border border-semantic-border bg-white px-5 py-5 shadow-sm">
            ...
            <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
              <div className="max-w-xl">
                ...
                <div className="mt-6 space-y-3">
                  {scannerPoints.map((point) => (<div key={point} className="flex gap-3 rounded-2xl border border-semantic-border bg-white px-4 py-4 shadow-sm">
        ...
        <section className="page-section border-y border-semantic-border/70 bg-white/72 py-12">
          <div className="container">
            ...
            <div className="mt-8 grid gap-4 lg:grid-cols-4">
              {workflow.map(([title, detail]) => (<article key={title} className="rounded-[1.35rem] border border-semantic-border bg-white px-5 py-5 shadow-sm">
...
function ProofMetric({ label, value }) {
    return (<div className="rounded-xl border border-semantic-border bg-white px-4 py-3">
