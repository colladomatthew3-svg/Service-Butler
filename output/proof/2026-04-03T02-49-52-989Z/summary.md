...
- Generated at: 2026-04-03T02:49:56.950Z
- Proof timestamp: 2026-04-03T02-49-52-989Z
- Status: PASS
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 2390 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 978 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 225 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| qualify-real-leads | PASS | 0 | 105 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
