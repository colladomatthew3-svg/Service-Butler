...
- Generated at: 2026-04-03T02:51:23.750Z
- Proof timestamp: 2026-04-03T02-51-19-520Z
- Status: PASS
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 2708 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 1013 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 212 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| qualify-real-leads | PASS | 0 | 101 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
...
live_provider_verified_leads=1
