...
exports.socialIntentConnector = void 0;
...
exports.socialIntentConnector = {
    ...
    async normalize(records, input) {
        return records.map((record, index) => {
            ...
            const sourceName = String(record.source_name || input.config.source_name || input.config.connector_name || (platform === "google_review" ? "Google Reviews" : "Reddit"));
