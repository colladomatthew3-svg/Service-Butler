...
async function SettingsPage() {
    ...
    return (<div>
      <h1>Settings</h1>
      <div className="panel">
        <form action={settings_1.updateSettings} style={{ display: "grid", gap: 8 }}>
          ...
          <textarea name="business_hours" rows={6} defaultValue={JSON.stringify(settings?.business_hours || { mon: "08:00-17:00", tue: "08:00-17:00" }, null, 2)}/>
