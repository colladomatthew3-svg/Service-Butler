...
- Generated at: 2026-04-03T03:06:42.320Z
- Proof timestamp: 2026-04-03T03-06-37-712Z
- Status: PASS
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 1137 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 1585 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 318 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| proof-book-verified-lead | PASS | 0 | 1248 | `proof-book-verified-lead/stdout.log` | `proof-book-verified-lead/stderr.log` |
| qualify-real-leads | PASS | 0 | 112 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
