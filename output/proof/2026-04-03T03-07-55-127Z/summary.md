...
- Generated at: 2026-04-03T03:07:59.454Z
- Proof timestamp: 2026-04-03T03-07-55-127Z
- Status: PASS
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 1327 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 1228 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 239 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| proof-book-verified-lead | PASS | 0 | 1218 | `proof-book-verified-lead/stdout.log` | `proof-book-verified-lead/stderr.log` |
| qualify-real-leads | PASS | 0 | 114 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
