...
- Generated at: 2026-04-03T02:20:28.302Z
- Proof timestamp: 2026-04-03T02-20-24-694Z
- Status: FAIL
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 1417 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 1632 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 339 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| qualify-real-leads | FAIL | 1 | 129 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
...
assignment created
outreach sent
- qualify-real-leads: real-lead-qualification=FAIL
...
live_provider_contactable_leads=6
live_provider_verified_leads=0
live_provider_review_leads=0
