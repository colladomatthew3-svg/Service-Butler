...
- Generated at: 2026-04-03T02:31:24.821Z
- Proof timestamp: 2026-04-03T02-31-22-002Z
- Status: FAIL
...
| --- | --- | ---: | ---: | --- | --- |
| operator-healthcheck | PASS | 0 | 1297 | `operator-healthcheck/stdout.log` | `operator-healthcheck/stderr.log` |
| validate-integrations | PASS | 0 | 1034 | `validate-integrations/stdout.log` | `validate-integrations/stderr.log` |
| operator-test | PASS | 0 | 205 | `operator-test/stdout.log` | `operator-test/stderr.log` |
| qualify-real-leads | FAIL | 1 | 105 | `qualify-real-leads/stdout.log` | `qualify-real-leads/stderr.log` |
